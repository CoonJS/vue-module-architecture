...
<template>
    <div class="event">
        ...
        <div class="event-type">
            <el-tag v-if="isCreateStatus" type="success" size="mini">Создание сделки #{{event.dealId}}</el-tag>
            <el-tag v-if="isUpdateStatus" size="mini">Обновление сделки #{{event.dealId}}</el-tag>
            <el-tag v-if="isDeleteStatus" type="danger" size="mini">Удаление сделки #{{event.dealId}}</el-tag>
        </div>
