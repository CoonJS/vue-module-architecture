    ...
    <el-card>
        <div slot="header" class="header">
            <div>
                ...
                <el-tag v-if="sale.closedMoment" type="success">Закрыта</el-tag>
            </div>
            <div>
                <el-button :type="sale.closedMoment ? 'success' : 'info'" size="mini">{{sale.status}}</el-button>
            </div>
        </div>
        <div class="body">
            <div>
            ...
            <div v-if="sale.closedMoment" class="close-date">
