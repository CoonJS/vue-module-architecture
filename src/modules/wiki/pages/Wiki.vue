                ...
                <div v-if="hasArticle">
                    <div class="header">
                        ...
                        <div>
                            ...
                            <template v-else>
                                <el-tooltip v-if="access.canEdit" effect="dark" content="Редактировать" placement="left">
                                    <el-button
                                        circle
                                        type="primary"
                                        size="mini"
                                ...
                                <el-tooltip v-if="access.canRemove" effect="dark" content="Удалить" placement="left">
                                    <el-button
                                        circle
                                        size="mini"
                                        :loading="isLoading"
