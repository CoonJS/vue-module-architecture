...
<template>
    <page-container>
        <div slot="header" class="header">
            <h3>Роли</h3>
            <el-button type="success" @click="showCreateRoleModal">Новая роль</el-button>
        </div>
        <div class="users">
            <el-table
                border
            ...
            >
                ...
                <el-table-column label="Действия">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.editable" size="mini" type="danger" @click="removeRole(scope.row.id)">Удалить</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
